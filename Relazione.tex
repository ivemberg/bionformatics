...
L'obiettivo del nostro progetto è eseguire un allineamento multiplo di sequenze (compresa la reference che utlizziamo come riferimento per i confronti) con dei tool a nostra scelta, producendo in output le variazioni individuate documentandole appositamente. \\
...
\end{table}
La sequenza di reference è stata presa dal sito NCI, ed è la prima sequenza registrata nel database raccolta a Wuhan nel dicembre del 2019.
